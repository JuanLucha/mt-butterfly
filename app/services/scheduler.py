        ...
        async with async_session_factory() as db:
            ...
            try:
                ...
                constrained_prompt = (
                    ...
                    f"5. Do NOT set, export, or look up credentials (GMAIL_USER, GMAIL_APP_PASSWORD, etc.). "
                    f"They are already in the environment and the CLI tools read them automatically.\n\n"
